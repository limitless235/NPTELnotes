...
- Then **end-to-end** on **iMessage** (“5 messages” in the captioning). Keys generated and stored on **sender and recipient devices**. **Apple has no master key**; **even Apple cannot decrypt** by technical means.
...
(Star Wars slide joke closes the part.)
